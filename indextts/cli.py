...
def main():
    ...
    parser.add_argument("--fast", action="store_true", default=False, help="Use infer_fast")
    parser.add_argument("--no_kv_cache", action="store_true", default=False, help="Disable kv cache for gpt2")
    ...
    if args.fast:
        tts.infer_fast(audio_prompt=args.voice, text=args.text.strip(), output_path=output_path)
    else:
